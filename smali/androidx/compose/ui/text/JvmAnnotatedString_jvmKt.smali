...
.method public static final transform(Landroidx/compose/ui/text/AnnotatedString;Lkotlin/jvm/functions/Function3;)Landroidx/compose/ui/text/AnnotatedString;
    ...
    invoke-static {v2, v3}, Lkotlin/collections/r;->v0([Ljava/lang/Object;Ljava/util/AbstractSet;)V
    ...
    invoke-direct {v4, v1, v1}, LM0/h;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    filled-new-array {v4}, [LM0/h;

    move-result-object v1

    invoke-static {v1}, Lkotlin/collections/I;->S([LM0/h;)Ljava/util/LinkedHashMap;

    move-result-object v1

    new-instance v4, Landroidx/compose/ui/text/JvmAnnotatedString_jvmKt$transform$1;

    invoke-direct {v4, v2, p1, p0, v1}, Landroidx/compose/ui/text/JvmAnnotatedString_jvmKt$transform$1;-><init>(Lkotlin/jvm/internal/F;Lkotlin/jvm/functions/Function3;Landroidx/compose/ui/text/AnnotatedString;Ljava/util/Map;)V
    ...
    new-instance v6, Lkotlin/collections/f;

    invoke-direct {v6, v3}, Lkotlin/collections/f;-><init>(Ljava/util/List;)V
    ...
    iget-object v10, v6, Lkotlin/collections/f;->f:Ljava/util/List;
    ...
    invoke-static {v3, v8, v10}, Lkotlin/collections/c;->c(III)V

    iput v3, v6, Lkotlin/collections/f;->d:I

    sub-int/2addr v8, v3

    iput v8, v6, Lkotlin/collections/f;->e:I
    ...
    sget-object v3, Lkotlin/collections/B;->c:Lkotlin/collections/B;

    goto :goto_2

    :cond_3
    new-instance v7, Lkotlin/collections/P;

    invoke-direct {v7, v6, v3, v0, v5}, Lkotlin/collections/P;-><init>(ILjava/util/Iterator;ZLkotlin/coroutines/Continuation;)V

    invoke-static {v7}, Lx0/r;->t(Lkotlin/jvm/functions/Function2;)Lg1/j;
