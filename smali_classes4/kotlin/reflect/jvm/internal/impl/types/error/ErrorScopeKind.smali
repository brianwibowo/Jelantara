...
.method static constructor <clinit>()V
    ...
    const-string v1, "Scope for integer literal type (%s)"

    const-string v2, "INTEGER_LITERAL_TYPE_SCOPE"
    ...
    const-string v1, "Error scope for erased receiver type"

    const-string v2, "ERASED_RECEIVER_TYPE_SCOPE"
    ...
    const-string v1, "Scope for abbreviation %s"

    const-string v2, "SCOPE_FOR_ABBREVIATION_TYPE"
    ...
    const-string v1, "Scope for stub type %s"

    const-string v2, "STUB_TYPE_SCOPE"
    ...
    const-string v1, "A scope for common supertype which is not a normal classifier"

    const-string v2, "NON_CLASSIFIER_SUPER_TYPE_SCOPE"
    ...
    const-string v1, "Scope for error type %s"

    const-string v2, "ERROR_TYPE_SCOPE"
    ...
    const-string v1, "Scope for unsupported type %s"

    const-string v2, "UNSUPPORTED_TYPE_SCOPE"
    ...
    const-string v1, "Error scope for class %s with arguments: %s"

    const-string v2, "SCOPE_FOR_ERROR_CLASS"
    ...
    const-string v1, "Error resolution candidate for call %s"

    const-string v2, "SCOPE_FOR_ERROR_RESOLUTION_CANDIDATE"
