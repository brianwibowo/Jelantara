...
.method private final connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    :try_start_1
    invoke-static {v1}, Lt1/Q;->i(Ljava/net/Socket;)Lokio/Source;
    ...
    invoke-static {v1}, Lt1/Q;->h(Ljava/net/Socket;)Lokio/Sink;
    ...
    invoke-static {p3, p4}, Lkotlin/jvm/internal/m;->m(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
...
.method private final connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    invoke-static {v3}, Lt1/Q;->i(Ljava/net/Socket;)Lokio/Source;
    ...
    invoke-static {v3}, Lt1/Q;->h(Ljava/net/Socket;)Lokio/Sink;
...
.method private final createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    invoke-virtual {v4, v5, v6, v7}, Lt1/N;->timeout(JLjava/util/concurrent/TimeUnit;)Lt1/N;

    invoke-interface {v1}, Lokio/Sink;->timeout()Lt1/N;
    ...
    invoke-static {p2, p3}, Lkotlin/jvm/internal/m;->m(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lt1/j;->P()Z

    move-result p1

    if-eqz p1, :cond_4

    invoke-interface {v1}, Lokio/BufferedSink;->b()Lt1/j;
...
.method public final connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    invoke-static {v3, v0, v4}, LF/c;->n(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final newCodec$okhttp(Lokhttp3/OkHttpClient;Lokhttp3/internal/http/RealInterceptorChain;)Lokhttp3/internal/http/ExchangeCodec;
    ...
    invoke-interface {v1}, Lokio/Source;->timeout()Lt1/N;
    ...
    invoke-virtual {v0, v3, v4, v5}, Lt1/N;->timeout(JLjava/util/concurrent/TimeUnit;)Lt1/N;

    invoke-interface {v2}, Lokio/Sink;->timeout()Lt1/N;
