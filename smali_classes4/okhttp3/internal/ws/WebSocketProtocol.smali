...
.method public final acceptHeader(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, p1}, Lkotlin/jvm/internal/m;->m(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
...
.method public final toggleMask(Lt1/g;[B)V
    .locals 7
    .param p1    # Lt1/g;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    :cond_0
    iget-object v2, p1, Lt1/g;->g:[B

    iget v3, p1, Lt1/g;->h:I

    iget v4, p1, Lt1/g;->i:I
    ...
    :cond_1
    iget-wide v2, p1, Lt1/g;->f:J

    iget-object v4, p1, Lt1/g;->c:Lt1/j;
    ...
    :goto_1
    invoke-virtual {p1, v2, v3}, Lt1/g;->f(J)I
