...
.field private static final UNICODE_BOMS:Lt1/B;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.field private static final VERIFY_AS_IP_ADDRESS:Lkotlin/text/l;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    invoke-static {v1}, Ln0/d;->j(Ljava/lang/String;)Lt1/k;

    move-result-object v1

    const-string v2, "feff"

    invoke-static {v2}, Ln0/d;->j(Ljava/lang/String;)Lt1/k;

    move-result-object v2

    const-string v3, "fffe"

    invoke-static {v3}, Ln0/d;->j(Ljava/lang/String;)Lt1/k;

    move-result-object v3

    const-string v4, "0000ffff"

    invoke-static {v4}, Ln0/d;->j(Ljava/lang/String;)Lt1/k;

    move-result-object v4

    const-string v5, "ffff0000"

    invoke-static {v5}, Ln0/d;->j(Ljava/lang/String;)Lt1/k;

    move-result-object v5

    filled-new-array {v1, v2, v3, v4, v5}, [Lt1/k;

    move-result-object v1

    invoke-static {v1}, Lt1/Q;->g([Lt1/k;)Lt1/B;

    move-result-object v1

    sput-object v1, Lokhttp3/internal/Util;->UNICODE_BOMS:Lt1/B;
    ...
    invoke-direct {v1, v2}, Lkotlin/text/l;-><init>(Ljava/lang/String;)V

    sput-object v1, Lokhttp3/internal/Util;->VERIFY_AS_IP_ADDRESS:Lkotlin/text/l;
    ...
    invoke-static {v0, v1}, Lkotlin/text/o;->s0(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    const-string v1, "Client"

    invoke-static {v0, v1}, Lkotlin/text/o;->t0(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static final canParseAsIpAddress(Ljava/lang/String;)Z
    ...
    sget-object v0, Lokhttp3/internal/Util;->VERIFY_AS_IP_ADDRESS:Lkotlin/text/l;

    invoke-virtual {v0, p0}, Lkotlin/text/l;->c(Ljava/lang/String;)Z
...
.method public static final checkDuration(Ljava/lang/String;JLjava/util/concurrent/TimeUnit;)I
    ...
    invoke-static {p1, p0}, Lkotlin/jvm/internal/m;->m(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
...
.method public static final delimiterOffset(Ljava/lang/String;Ljava/lang/String;II)I
    ...
    invoke-static {p1, v1}, Lkotlin/text/o;->e0(Ljava/lang/CharSequence;C)Z
...
.method public static final hasIntersection([Ljava/lang/String;[Ljava/lang/String;Ljava/util/Comparator;)Z
    ...
    invoke-static {p1}, Lkotlin/jvm/internal/m;->k([Ljava/lang/Object;)Lkotlin/collections/d;

    move-result-object v4

    :cond_3
    invoke-virtual {v4}, Lkotlin/collections/d;->hasNext()Z

    move-result v5

    if-eqz v5, :cond_2

    invoke-virtual {v4}, Lkotlin/collections/d;->next()Ljava/lang/Object;
...
.method public static final isCivilized(Lokhttp3/internal/io/FileSystem;Ljava/io/File;)Z
    ...
    invoke-static {v0, p0}, La/a;->f(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method public static final isHealthy(Ljava/net/Socket;Lokio/BufferedSource;)Z
    ...
    invoke-interface {p1}, Lokio/BufferedSource;->P()Z
...
.method public static final readBomAsCharset(Lokio/BufferedSource;Ljava/nio/charset/Charset;)Ljava/nio/charset/Charset;
    ...
    sget-object v0, Lokhttp3/internal/Util;->UNICODE_BOMS:Lt1/B;

    invoke-interface {p0, v0}, Lokio/BufferedSource;->c0(Lt1/B;)I
...
.method public static final skipAll(Lt1/j;B)I
    .locals 3
    .param p0    # Lt1/j;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-virtual {p0, v1, v2}, Lt1/j;->o(J)B
...
.method public static final skipAll(Lokio/Source;ILjava/util/concurrent/TimeUnit;)Z
    ...
    .line 2
    invoke-interface {p0}, Lokio/Source;->timeout()Lt1/N;

    move-result-object v2

    invoke-virtual {v2}, Lt1/N;->hasDeadline()Z
    ...
    invoke-virtual {v2}, Lt1/N;->deadlineNanoTime()J
    ...
    invoke-virtual {v2, p1, p2}, Lt1/N;->deadlineNanoTime(J)Lt1/N;
    ...
    .line 7
    invoke-interface {p0, p1, v7, v8}, Lokio/Source;->read(Lt1/j;J)J
    ...
    invoke-virtual {p0, v0, v1}, Lt1/N;->deadlineNanoTime(J)Lt1/N;
...
.method public static final threadFactory(Ljava/lang/String;Z)Ljava/util/concurrent/ThreadFactory;
    ...
    invoke-direct {v0, p0, p1}, Ls1/a;-><init>(Ljava/lang/String;Z)V
...
.method public static final toHeaders(Ljava/util/List;)Lokhttp3/Headers;
    ...
    invoke-virtual {v1}, Lokhttp3/internal/http2/Header;->component1()Lt1/k;

    move-result-object v2

    invoke-virtual {v1}, Lokhttp3/internal/http2/Header;->component2()Lt1/k;

    move-result-object v1

    invoke-virtual {v2}, Lt1/k;->q()Ljava/lang/String;
...
.method public static final withSuppressed(Ljava/lang/Exception;Ljava/util/List;)Ljava/lang/Throwable;
    ...
    invoke-static {p0, v0}, Lb1/a;->c(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
...
.method public static final writeMedium(Lokio/BufferedSink;I)V
    ...
    invoke-interface {p0, v0}, Lokio/BufferedSink;->R(I)Lokio/BufferedSink;
    ...
    invoke-interface {p0, p1}, Lokio/BufferedSink;->R(I)Lokio/BufferedSink;
