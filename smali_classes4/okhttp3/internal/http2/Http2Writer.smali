...
.field private final hpackBuffer:Lt1/j;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.method public constructor <init>(Lokio/BufferedSink;Z)V
    ...
    iput-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lt1/j;
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLt1/j;ILkotlin/jvm/internal/g;)V
...
.method private final writeContinuationFrames(IJ)V
    ...
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lt1/j;
...
.method public final declared-synchronized connectionPreface()V
    ...
    sget-object v2, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lt1/k;

    invoke-virtual {v2}, Lt1/k;->e()Ljava/lang/String;

    move-result-object v2

    invoke-static {v2, v1}, Lkotlin/jvm/internal/m;->m(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v1, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lt1/k;

    invoke-interface {v0, v1}, Lokio/BufferedSink;->a0(Lt1/k;)Lokio/BufferedSink;
...
.method public final declared-synchronized data(ZILt1/j;I)V
    .locals 1
    .param p3    # Lt1/j;
    ...
    invoke-virtual {p0, p2, p1, p3, p4}, Lokhttp3/internal/http2/Http2Writer;->dataFrame(IILt1/j;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final dataFrame(IILt1/j;I)V
    .locals 2
    .param p3    # Lt1/j;
        .annotation build Lorg/jetbrains/annotations/Nullable;
        .end annotation
    ...
    invoke-interface {p1, p3, v0, v1}, Lokio/Sink;->write(Lt1/j;J)V
...
.method public final frameHeader(IIII)V
    ...
    invoke-interface {p2, p3}, Lokio/BufferedSink;->R(I)Lokio/BufferedSink;
    ...
    invoke-interface {p2, p1}, Lokio/BufferedSink;->h(I)Lokio/BufferedSink;
...
.method public final declared-synchronized goAway(ILokhttp3/internal/http2/ErrorCode;[B)V
    ...
    invoke-interface {v0, p1}, Lokio/BufferedSink;->h(I)Lokio/BufferedSink;
    ...
    invoke-interface {p1, p2}, Lokio/BufferedSink;->h(I)Lokio/BufferedSink;
...
.method public final declared-synchronized headers(ZILjava/util/List;)V
    ...
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lt1/j;

    iget-wide v0, p3, Lt1/j;->d:J
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lt1/j;

    invoke-interface {p1, v4, v2, v3}, Lokio/Sink;->write(Lt1/j;J)V
...
.method public final declared-synchronized ping(ZII)V
    ...
    invoke-interface {p1, p3}, Lokio/BufferedSink;->h(I)Lokio/BufferedSink;
...
.method public final declared-synchronized pushPromise(IILjava/util/List;)V
    ...
    invoke-interface {v2, p2}, Lokio/BufferedSink;->h(I)Lokio/BufferedSink;

    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lokio/BufferedSink;

    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lt1/j;

    invoke-interface {p2, v2, v3, v4}, Lokio/Sink;->write(Lt1/j;J)V
...
.method public final declared-synchronized settings(Lokhttp3/internal/http2/Settings;)V
    ...
    invoke-interface {v4, v3}, Lokio/BufferedSink;->N(I)Lokio/BufferedSink;
    ...
    invoke-interface {v3, v2}, Lokio/BufferedSink;->h(I)Lokio/BufferedSink;
...
.method public final declared-synchronized windowUpdate(IJ)V
    ...
    invoke-static {p2, p1}, Lkotlin/jvm/internal/m;->m(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
