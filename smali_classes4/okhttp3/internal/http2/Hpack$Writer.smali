...
# direct methods
.method public constructor <init>(ILt1/j;)V
    .locals 7
    .param p2    # Lt1/j;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
...
.method public constructor <init>(IZLt1/j;)V
    .locals 1
    .param p3    # Lt1/j;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 6
    iput-object p3, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lt1/j;
...
.method public synthetic constructor <init>(IZLt1/j;ILkotlin/jvm/internal/g;)V
    .locals 0
    ...
    .line 11
    :cond_1
    invoke-direct {p0, p1, p2, p3}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLt1/j;)V
...
.method public final writeByteString(Lt1/k;)V
    .locals 5
    .param p1    # Lt1/k;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-virtual {v0, p1}, Lokhttp3/internal/http2/Huffman;->encodedLength(Lt1/k;)I
    ...
    invoke-virtual {v0, p1, v2}, Lokhttp3/internal/http2/Huffman;->encode(Lt1/k;Lokio/BufferedSink;)V

    iget-wide v3, v2, Lt1/j;->d:J

    invoke-virtual {v2, v3, v4}, Lt1/j;->L(J)Lt1/k;
    ...
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lt1/j;
...
.method public final writeHeaders(Ljava/util/List;)V
    ...
    iget-object v4, v2, Lokhttp3/internal/http2/Header;->name:Lt1/k;

    invoke-virtual {v4}, Lt1/k;->p()Lt1/k;

    move-result-object v4

    iget-object v5, v2, Lokhttp3/internal/http2/Header;->value:Lt1/k;
    ...
    iget-object v10, v10, Lokhttp3/internal/http2/Header;->value:Lt1/k;
    ...
    iget-object v6, v6, Lokhttp3/internal/http2/Header;->value:Lt1/k;
    ...
    iget-object v12, v12, Lokhttp3/internal/http2/Header;->name:Lt1/k;
    ...
    iget-object v12, v12, Lokhttp3/internal/http2/Header;->value:Lt1/k;
    ...
    iget-object v6, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lt1/j;

    invoke-virtual {v6, v7}, Lt1/j;->j0(I)V

    invoke-virtual {p0, v4}, Lokhttp3/internal/http2/Hpack$Writer;->writeByteString(Lt1/k;)V

    invoke-virtual {p0, v5}, Lokhttp3/internal/http2/Hpack$Writer;->writeByteString(Lt1/k;)V
    ...
    :cond_9
    sget-object v8, Lokhttp3/internal/http2/Header;->PSEUDO_PREFIX:Lt1/k;
    ...
    invoke-virtual {v8}, Lt1/k;->d()I

    move-result v9

    invoke-virtual {v4, v1, v8, v9}, Lt1/k;->l(ILt1/k;I)Z

    move-result v8

    if-eqz v8, :cond_a

    sget-object v8, Lokhttp3/internal/http2/Header;->TARGET_AUTHORITY:Lt1/k;
...
.method public final writeInt(III)V
    ...
    iget-object p2, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lt1/j;

    or-int/2addr p1, p3

    invoke-virtual {p2, p1}, Lt1/j;->j0(I)V
    ...
    invoke-virtual {v0, p3}, Lt1/j;->j0(I)V
    ...
    invoke-virtual {v0, p2}, Lt1/j;->j0(I)V
