...
.method private final getName(I)Lt1/k;
    .locals 3
    ...
    iget-object p1, p1, Lokhttp3/internal/http2/Header;->name:Lt1/k;
...
.method private final readLiteralHeaderWithIncrementalIndexingIndexedName(I)V
    ...
    invoke-direct {p0, p1}, Lokhttp3/internal/http2/Hpack$Reader;->getName(I)Lt1/k;

    move-result-object p1

    invoke-virtual {p0}, Lokhttp3/internal/http2/Hpack$Reader;->readByteString()Lt1/k;

    move-result-object v0

    new-instance v1, Lokhttp3/internal/http2/Header;

    invoke-direct {v1, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Lt1/k;Lt1/k;)V
...
.method private final readLiteralHeaderWithIncrementalIndexingNewName()V
    ...
    invoke-virtual {v0, v1}, Lokhttp3/internal/http2/Hpack;->checkLowercase(Lt1/k;)Lt1/k;
    ...
    invoke-direct {v2, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Lt1/k;Lt1/k;)V
...
.method private final readLiteralHeaderWithoutIndexingIndexedName(I)V
    ...
    invoke-direct {v2, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Lt1/k;Lt1/k;)V
...
.method private final readLiteralHeaderWithoutIndexingNewName()V
    ...
    invoke-direct {v3, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Lt1/k;Lt1/k;)V
...
.method public final readByteString()Lt1/k;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {v0, v1, v2}, Lt1/j;->L(J)Lt1/k;
    ...
    invoke-interface {v0, v2, v3}, Lokio/BufferedSource;->L(J)Lt1/k;
...
.method public final readHeaders()V
    ...
    invoke-interface {v0}, Lokio/BufferedSource;->P()Z
