...
.method public final decode(Lokio/BufferedSource;JLokio/BufferedSink;)V
    ...
    invoke-interface {p4, v5}, Lokio/BufferedSink;->R(I)Lokio/BufferedSink;
    ...
    invoke-interface {p4, p2}, Lokio/BufferedSink;->R(I)Lokio/BufferedSink;
...
.method public final encode(Lt1/k;Lokio/BufferedSink;)V
    .locals 8
    .param p1    # Lt1/k;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-virtual {p1, v3}, Lt1/k;->i(I)B
    ...
    invoke-interface {p2, v3}, Lokio/BufferedSink;->R(I)Lokio/BufferedSink;
    ...
    invoke-interface {p2, p1}, Lokio/BufferedSink;->R(I)Lokio/BufferedSink;

    :cond_2
    return-void
.end method

.method public final encodedLength(Lt1/k;)I
    .locals 7
    .param p1    # Lt1/k;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
