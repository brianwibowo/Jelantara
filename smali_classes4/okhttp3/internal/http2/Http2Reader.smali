...
.method private final readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-interface {v0, v1, v2}, Lokio/BufferedSource;->L(J)Lt1/k;

    move-result-object v0

    :cond_0
    invoke-interface {p1, p4, p3, v0}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;Lt1/k;)V
...
.method private final readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 4
    invoke-static {p3, p2, p4}, LF/c;->j(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-static {v1, p2}, Lb1/a;->E(ILf1/d;)Lf1/b;

    move-result-object p2

    iget v1, p2, Lf1/b;->c:I

    iget v2, p2, Lf1/b;->d:I

    iget p2, p2, Lf1/b;->e:I
...
.method public final readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    sget-object v0, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lt1/k;
    ...
    invoke-interface {p1, v1, v2}, Lokio/BufferedSource;->L(J)Lt1/k;
    ...
    invoke-static {v3, v2}, Lkotlin/jvm/internal/m;->m(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
