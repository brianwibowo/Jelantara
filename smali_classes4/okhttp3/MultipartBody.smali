...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "parts",
        "<init>",
        "(Lt1/k;Lokhttp3/MediaType;Ljava/util/List;)V",
        "Lokio/BufferedSink;",
        "sink",
        "",
        "countBytes",
...
# instance fields
.field private final boundaryByteString:Lt1/k;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.method public constructor <init>(Lt1/k;Lokhttp3/MediaType;Ljava/util/List;)V
    .locals 1
    .param p1    # Lt1/k;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    iput-object p1, p0, Lokhttp3/MultipartBody;->boundaryByteString:Lt1/k;
...
.method private final writeOrCountBytes(Lokio/BufferedSink;Z)J
    ...
    iget-object v8, p0, Lokhttp3/MultipartBody;->boundaryByteString:Lt1/k;

    invoke-interface {p1, v8}, Lokio/BufferedSink;->a0(Lt1/k;)Lokio/BufferedSink;
    ...
    invoke-interface {p1, v11}, Lokio/BufferedSink;->t(Ljava/lang/String;)Lokio/BufferedSink;

    move-result-object v11

    sget-object v12, Lokhttp3/MultipartBody;->COLONSPACE:[B

    invoke-interface {v11, v12}, Lokio/BufferedSink;->D([B)Lokio/BufferedSink;
    ...
    invoke-interface {v11, v9}, Lokio/BufferedSink;->t(Ljava/lang/String;)Lokio/BufferedSink;

    move-result-object v9

    sget-object v11, Lokhttp3/MultipartBody;->CRLF:[B

    invoke-interface {v9, v11}, Lokio/BufferedSink;->D([B)Lokio/BufferedSink;
    ...
    invoke-interface {p1, v8}, Lokio/BufferedSink;->t(Ljava/lang/String;)Lokio/BufferedSink;
    ...
    invoke-interface {v8, v7}, Lokio/BufferedSink;->t(Ljava/lang/String;)Lokio/BufferedSink;
    ...
    invoke-interface {p1, v9}, Lokio/BufferedSink;->t(Ljava/lang/String;)Lokio/BufferedSink;

    move-result-object v9

    invoke-interface {v9, v7, v8}, Lokio/BufferedSink;->J(J)Lokio/BufferedSink;
    ...
    iget-object v2, p0, Lokhttp3/MultipartBody;->boundaryByteString:Lt1/k;

    invoke-interface {p1, v2}, Lokio/BufferedSink;->a0(Lt1/k;)Lokio/BufferedSink;
...
.method public final boundary()Ljava/lang/String;
    ...
    iget-object v0, p0, Lokhttp3/MultipartBody;->boundaryByteString:Lt1/k;
