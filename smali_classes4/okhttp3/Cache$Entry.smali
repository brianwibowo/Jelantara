...
.method public constructor <init>(Lokio/Source;)V
    ...
    .line 3
    invoke-virtual {v0, v1, v2}, Lt1/G;->p(J)Ljava/lang/String;
    ...
    .line 44
    :goto_5
    invoke-static {p1, v4}, La/a;->f(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-static {v3, v1}, Lkotlin/jvm/internal/m;->m(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
...
.method private final readCertificateList(Lokio/BufferedSource;)Ljava/util/List;
    ...
    sget-object v7, Lt1/k;->f:Lt1/k;

    invoke-static {v5}, Ln0/d;->i(Ljava/lang/String;)Lt1/k;

    move-result-object v5

    invoke-static {v5}, Lkotlin/jvm/internal/m;->d(Ljava/lang/Object;)V

    invoke-virtual {v6, v5}, Lt1/j;->f0(Lt1/k;)V

    new-instance v5, Lt1/h;

    invoke-direct {v5, v6, v0}, Lt1/h;-><init>(Lokio/BufferedSource;I)V
...
.method private final writeCertList(Lokio/BufferedSink;Ljava/util/List;)V
    ...
    invoke-static {v0}, Ln0/d;->m([B)Lt1/k;
...
.method public final writeTo(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    invoke-virtual {p1, v1}, Lt1/F;->t(Ljava/lang/String;)Lokio/BufferedSink;

    const/16 v1, 0xa

    invoke-virtual {p1, v1}, Lt1/F;->R(I)Lokio/BufferedSink;

    iget-object v2, p0, Lokhttp3/Cache$Entry;->requestMethod:Ljava/lang/String;

    invoke-virtual {p1, v2}, Lt1/F;->t(Ljava/lang/String;)Lokio/BufferedSink;
    ...
    invoke-virtual {p1, v2, v3}, Lt1/F;->J(J)Lokio/BufferedSink;
    ...
    invoke-virtual {p1, v6}, Lt1/F;->t(Ljava/lang/String;)Lokio/BufferedSink;

    invoke-virtual {p1, v4}, Lt1/F;->t(Ljava/lang/String;)Lokio/BufferedSink;
    ...
    invoke-virtual {p1, v3}, Lt1/F;->t(Ljava/lang/String;)Lokio/BufferedSink;
    ...
    invoke-virtual {p1, v5}, Lt1/F;->t(Ljava/lang/String;)Lokio/BufferedSink;
    ...
    invoke-virtual {p1, v0}, Lt1/F;->t(Ljava/lang/String;)Lokio/BufferedSink;
