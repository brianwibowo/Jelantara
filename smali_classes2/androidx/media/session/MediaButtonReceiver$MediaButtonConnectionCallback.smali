...
.field private mMediaBrowser:Landroid/support/v4/media/e;
...
.method private finish()V
    ...
    iget-object v0, p0, Landroidx/media/session/MediaButtonReceiver$MediaButtonConnectionCallback;->mMediaBrowser:Landroid/support/v4/media/e;

    iget-object v0, v0, Landroid/support/v4/media/e;->a:Landroid/support/v4/media/d;

    iget-object v1, v0, Landroid/support/v4/media/d;->f:LE/c;
    ...
    :try_start_0
    invoke-virtual {v1, v3, v4, v2}, LE/c;->s(ILandroid/os/Bundle;Landroid/os/Messenger;)V
    :try_end_0
...
.method public onConnected()V
    ...
    iget-object v1, p0, Landroidx/media/session/MediaButtonReceiver$MediaButtonConnectionCallback;->mMediaBrowser:Landroid/support/v4/media/e;

    iget-object v1, v1, Landroid/support/v4/media/e;->a:Landroid/support/v4/media/d;
    ...
    invoke-static {v2, v3}, Landroid/support/v4/media/session/MediaSessionCompat$Token;->a(Landroid/os/Parcelable;Landroid/support/v4/media/session/IMediaSession;)Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    iget-object v1, v2, Landroid/support/v4/media/session/d;->a:Landroid/media/session/MediaController;
...
.method public setMediaBrowser(Landroid/support/v4/media/e;)V
    .locals 0

    iput-object p1, p0, Landroidx/media/session/MediaButtonReceiver$MediaButtonConnectionCallback;->mMediaBrowser:Landroid/support/v4/media/e;
