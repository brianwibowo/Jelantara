...
.field private final pages:Lkotlin/collections/q;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lkotlin/collections/q;"
        }
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/paging/FlattenedPageEventStorage;->pages:Lkotlin/collections/q;
...
.method private final handleInsert(Landroidx/paging/PageEvent$Insert;)V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/paging/FlattenedPageEventStorage;->pages:Lkotlin/collections/q;
    ...
    invoke-virtual {v0, p1}, Lkotlin/collections/q;->addAll(Ljava/util/Collection;)Z
    ...
    invoke-direct {v3, v0, v1, v2}, Lf1/c;-><init>(III)V

    :goto_0
    iget-boolean v0, v3, Lf1/c;->e:Z

    if-eqz v0, :cond_3

    invoke-virtual {v3}, Lkotlin/collections/G;->nextInt()I

    move-result v0

    iget-object v1, p0, Landroidx/paging/FlattenedPageEventStorage;->pages:Lkotlin/collections/q;
    ...
    invoke-virtual {v1, v0}, Lkotlin/collections/q;->addFirst(Ljava/lang/Object;)V
