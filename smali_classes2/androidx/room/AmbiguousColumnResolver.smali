...
.method public static synthetic a(Ljava/util/ArrayList;ILjava/util/List;)LM0/r;
    .locals 0

    invoke-static {p0, p1, p2}, Landroidx/room/AmbiguousColumnResolver;->resolve$lambda$16$lambda$15(Ljava/util/List;ILjava/util/List;)LM0/r;
...
.method public static synthetic b([Ljava/lang/String;Ljava/util/ArrayList;IIILjava/util/List;)LM0/r;
    .locals 0

    invoke-static/range {p0 .. p5}, Landroidx/room/AmbiguousColumnResolver;->resolve$lambda$16$lambda$7([Ljava/lang/String;Ljava/util/List;IIILjava/util/List;)LM0/r;
...
.method public static synthetic c(Lkotlin/jvm/internal/F;Ljava/util/List;)LM0/r;
    .locals 0

    invoke-static {p0, p1}, Landroidx/room/AmbiguousColumnResolver;->resolve$lambda$19(Lkotlin/jvm/internal/F;Ljava/util/List;)LM0/r;
...
.method private final dfs(Ljava/util/List;Ljava/util/List;ILkotlin/jvm/functions/Function1;)V
    ...
    invoke-static {p2}, Lkotlin/collections/u;->V0(Ljava/lang/Iterable;)Ljava/util/List;
...
.method public static final resolve([Ljava/lang/String;[[Ljava/lang/String;)[[I
    ...
    .line 11
    invoke-static {v2, v6}, Lkotlin/collections/A;->Z(Ljava/util/Collection;[Ljava/lang/Object;)V
    ...
    .line 14
    iget-object v10, v2, LO0/k;->c:LO0/f;

    .line 15
    invoke-virtual {v10, v8}, LO0/f;->containsKey(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v4, v10}, LO0/c;->add(Ljava/lang/Object;)Z
    ...
    .line 17
    :cond_6
    invoke-static {v4}, Lx0/r;->e(LO0/c;)LO0/c;
    ...
    .line 25
    invoke-virtual {v0, v3}, LO0/c;->listIterator(I)Ljava/util/ListIterator;
    ...
    invoke-virtual {v15}, LO0/a;->next()Ljava/lang/Object;
    ...
    invoke-virtual {v13, v3}, LO0/c;->add(Ljava/lang/Object;)Z
    ...
    .line 29
    :cond_9
    invoke-static {v13}, Lx0/r;->e(LO0/c;)LO0/c;

    move-result-object v3

    .line 30
    invoke-virtual {v3}, LO0/c;->isEmpty()Z
    ...
    .line 33
    invoke-static {v0, v12, v1}, LF/c;->n(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v14, v5, v6}, Landroidx/room/b;-><init>(Ljava/util/ArrayList;I)V
    ...
    invoke-direct {v8, v0, v1}, Landroidx/room/c;-><init>(Lkotlin/jvm/internal/F;I)V
    ...
    invoke-static {v2}, Lkotlin/collections/u;->U0(Ljava/util/List;)[I
...
.method private static final resolve$lambda$16$lambda$15(Ljava/util/List;ILjava/util/List;)LM0/r;
    .locals 4
    ...
    invoke-direct {p1, v0, p2}, Landroidx/room/AmbiguousColumnResolver$Match;-><init>(Lf1/d;Ljava/util/List;)V
...
.method private static final resolve$lambda$16$lambda$7([Ljava/lang/String;Ljava/util/List;IIILjava/util/List;)LM0/r;
    .locals 8
    ...
    invoke-direct {p2, p3, p4, p5}, Lf1/b;-><init>(III)V

    invoke-direct {p1, p2, v0}, Landroidx/room/AmbiguousColumnResolver$Match;-><init>(Lf1/d;Ljava/util/List;)V
...
.method private static final resolve$lambda$19(Lkotlin/jvm/internal/F;Ljava/util/List;)LM0/r;
    .locals 1
