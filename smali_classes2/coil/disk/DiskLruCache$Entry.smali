...
.method public constructor <init>(Lcoil/disk/DiskLruCache;Ljava/lang/String;)V
    ...
    invoke-static {v3}, Lcoil/disk/DiskLruCache;->access$getDirectory$p(Lcoil/disk/DiskLruCache;)Lt1/D;
    ...
    invoke-virtual {v3, v4}, Lt1/D;->c(Ljava/lang/String;)Lt1/D;
...
.method public final snapshot()Lcoil/disk/DiskLruCache$Snapshot;
    ...
    invoke-virtual {v6, v5}, Lt1/q;->exists(Lt1/D;)Z
...
.method public final writeLengths(Lokio/BufferedSink;)V
    ...
    invoke-interface {p1, v5}, Lokio/BufferedSink;->R(I)Lokio/BufferedSink;

    move-result-object v5

    invoke-interface {v5, v3, v4}, Lokio/BufferedSink;->J(J)Lokio/BufferedSink;
