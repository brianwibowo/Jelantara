...
.field public static volatile j:Lcom/bumptech/glide/load/resource/bitmap/s;
...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Lcom/bumptech/glide/load/resource/bitmap/s;->g:Z

    sput-boolean v2, Lcom/bumptech/glide/load/resource/bitmap/s;->h:Z
    ...
    sput-object v0, Lcom/bumptech/glide/load/resource/bitmap/s;->i:Ljava/io/File;

    const/4 v0, -0x1

    sput v0, Lcom/bumptech/glide/load/resource/bitmap/s;->k:I
...
.method public constructor <init>()V
    ...
    iput-boolean v1, v0, Lcom/bumptech/glide/load/resource/bitmap/s;->e:Z
    ...
    iput-object v2, v0, Lcom/bumptech/glide/load/resource/bitmap/s;->f:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :goto_3
    iput-boolean v1, v0, Lcom/bumptech/glide/load/resource/bitmap/s;->a:Z
    ...
    iput v1, v0, Lcom/bumptech/glide/load/resource/bitmap/s;->b:I

    iput v3, v0, Lcom/bumptech/glide/load/resource/bitmap/s;->c:I
    ...
    iput v1, v0, Lcom/bumptech/glide/load/resource/bitmap/s;->c:I

    :goto_4
    return-void
.end method

.method public static a()Lcom/bumptech/glide/load/resource/bitmap/s;
    .locals 2

    sget-object v0, Lcom/bumptech/glide/load/resource/bitmap/s;->j:Lcom/bumptech/glide/load/resource/bitmap/s;
    ...
    :try_start_0
    sget-object v1, Lcom/bumptech/glide/load/resource/bitmap/s;->j:Lcom/bumptech/glide/load/resource/bitmap/s;
    ...
    sput-object v1, Lcom/bumptech/glide/load/resource/bitmap/s;->j:Lcom/bumptech/glide/load/resource/bitmap/s;
...
.method public final b(IIZZ)Z
    ...
    :cond_1
    iget-boolean p3, p0, Lcom/bumptech/glide/load/resource/bitmap/s;->a:Z
    ...
    :cond_3
    sget-boolean p3, Lcom/bumptech/glide/load/resource/bitmap/s;->h:Z
    ...
    :cond_5
    sget-boolean p3, Lcom/bumptech/glide/load/resource/bitmap/s;->g:Z

    if-eqz p3, :cond_7

    iget-object p3, p0, Lcom/bumptech/glide/load/resource/bitmap/s;->f:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_9
    iget p3, p0, Lcom/bumptech/glide/load/resource/bitmap/s;->c:I
    ...
    :try_start_0
    iget p2, p0, Lcom/bumptech/glide/load/resource/bitmap/s;->d:I

    const/4 p3, 0x1

    add-int/2addr p2, p3

    iput p2, p0, Lcom/bumptech/glide/load/resource/bitmap/s;->d:I
    ...
    sget-object p2, Lcom/bumptech/glide/load/resource/bitmap/s;->i:Ljava/io/File;
    ...
    sget p4, Lcom/bumptech/glide/load/resource/bitmap/s;->k:I
    ...
    :cond_e
    iget p4, p0, Lcom/bumptech/glide/load/resource/bitmap/s;->b:I
    ...
    :goto_1
    iput-boolean p4, p0, Lcom/bumptech/glide/load/resource/bitmap/s;->e:Z
    ...
    invoke-static {p4, p1}, Lio/sentry/android/core/SentryLogcatAdapter;->w(Ljava/lang/String;Ljava/lang/String;)I
    ...
    :cond_10
    :goto_2
    iget-boolean p1, p0, Lcom/bumptech/glide/load/resource/bitmap/s;->e:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
