...
.method private static string(Lokio/BufferedSink;Ljava/lang/String;)V
    ...
    invoke-interface {p0, v1}, Lokio/BufferedSink;->R(I)Lokio/BufferedSink;
    ...
    invoke-interface {p0, p1, v4, v3}, Lokio/BufferedSink;->u(Ljava/lang/String;II)Lokio/BufferedSink;

    :cond_3
    invoke-interface {p0, v5}, Lokio/BufferedSink;->t(Ljava/lang/String;)Lokio/BufferedSink;
    ...
    invoke-interface {p0, p1, v4, v2}, Lokio/BufferedSink;->u(Ljava/lang/String;II)Lokio/BufferedSink;
...
.method public final syntaxError(Ljava/lang/String;)Lcom/airbnb/lottie/parser/moshi/JsonEncodingException;
    ...
    invoke-static {p1, v1}, LF/c;->v(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
