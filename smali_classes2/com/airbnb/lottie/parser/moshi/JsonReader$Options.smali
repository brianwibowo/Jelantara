...
# instance fields
.field final doubleQuoteSuffix:Lt1/B;

.field final strings:[Ljava/lang/String;


# direct methods
.method private constructor <init>([Ljava/lang/String;Lt1/B;)V
    .locals 0
    ...
    iput-object p2, p0, Lcom/airbnb/lottie/parser/moshi/JsonReader$Options;->doubleQuoteSuffix:Lt1/B;
...
.method public static varargs of([Ljava/lang/String;)Lcom/airbnb/lottie/parser/moshi/JsonReader$Options;
    ...
    iget-wide v3, v1, Lt1/j;->d:J

    invoke-virtual {v1, v3, v4}, Lt1/j;->L(J)Lt1/k;
    ...
    invoke-direct {v1, p0, v0}, Lcom/airbnb/lottie/parser/moshi/JsonReader$Options;-><init>([Ljava/lang/String;Lt1/B;)V
    :try_end_0
