...
.method public static evaluate(FII)I
    ...
    invoke-static {v4, v0, p0, v0}, LF/c;->c(FFFF)F

    move-result v0

    invoke-static {v5, v2, p0, v2}, LF/c;->c(FFFF)F

    move-result v2

    invoke-static {v6, v3, p0, v3}, LF/c;->c(FFFF)F

    move-result v3

    invoke-static {p2, p1, p0, p1}, LF/c;->c(FFFF)F
