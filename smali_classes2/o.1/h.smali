...
# direct methods
.method public constructor <init>(Ll/z;Ljava/util/HashMap;Lapp/jelantara/android/ui/listener/PostPagingListener;Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Lp/n;)V
    .locals 1
    ...
    iput-object p1, p0, Lo/h;->a:Ll/z;

    iput-object p2, p0, Lo/h;->b:Ljava/util/HashMap;

    check-cast p3, Lj/g;

    iput-object p3, p0, Lo/h;->c:Lj/g;

    iput-object p4, p0, Lo/h;->d:Landroid/content/Context;

    iput-object p5, p0, Lo/h;->e:Ljava/lang/String;

    iput-object p6, p0, Lo/h;->f:Ljava/lang/String;

    iput-object p7, p0, Lo/h;->g:Lp/n;
...
.method public final load(Landroidx/paging/PagingSource$LoadParams;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-direct {v3, v1, v0}, Lo/g;-><init>(Lo/h;Lkotlin/coroutines/Continuation;)V

    :goto_0
    iget-object v0, v3, Lo/g;->j:Ljava/lang/Object;
    ...
    iget-object v9, v3, Lo/g;->f:Ljava/lang/Integer;

    iget-object v10, v3, Lo/g;->e:Lkotlin/jvm/internal/B;

    iget-object v11, v3, Lo/g;->d:Lapp/jelantara/android/network/response/settingsResponse/SettingsResponse;

    iget-object v3, v3, Lo/g;->c:Lo/h;
    ...
    iget-object v15, v1, Lo/h;->b:Ljava/util/HashMap;
    ...
    iget-object v13, v1, Lo/h;->d:Landroid/content/Context;
    ...
    iget-object v14, v1, Lo/h;->a:Ll/z;

    iget-object v0, v1, Lo/h;->f:Ljava/lang/String;

    iget-object v13, v1, Lo/h;->e:Ljava/lang/String;

    invoke-static/range {v16 .. v16}, Lkotlin/jvm/internal/m;->d(Ljava/lang/Object;)V

    iget-object v7, v1, Lo/h;->g:Lp/n;

    iput-object v1, v3, Lo/g;->c:Lo/h;

    iput-object v11, v3, Lo/g;->d:Lapp/jelantara/android/network/response/settingsResponse/SettingsResponse;

    iput-object v10, v3, Lo/g;->e:Lkotlin/jvm/internal/B;

    iput-object v12, v3, Lo/g;->f:Ljava/lang/Integer;
    ...
    invoke-direct/range {v13 .. v20}, Ll/o;-><init>(Ll/z;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/HashMap;Lapp/jelantara/android/ui/interfaces/BookmarkInterface;Lkotlin/coroutines/Continuation;)V
    ...
    check-cast v4, Lapp/jelantara/android/network/Resource$Failure;

    invoke-virtual {v4}, Lapp/jelantara/android/network/Resource$Failure;->getErrorCode()Ljava/lang/Integer;
    ...
    iget-object v0, v3, Lo/h;->c:Lj/g;

    invoke-interface {v0}, Lapp/jelantara/android/ui/listener/PostPagingListener;->d()V
    ...
    new-instance v7, Lapp/jelantara/android/ui/adapters/PostPagingSource$load$collectionType$1;

    invoke-direct {v7}, Lapp/jelantara/android/ui/adapters/PostPagingSource$load$collectionType$1;-><init>()V
    ...
    invoke-virtual/range {v18 .. v18}, Lapp/jelantara/android/network/APIData;->getPostListSetting()Lcom/appmysite/baselibrary/custompost/AMSPostListValue;
    ...
    invoke-static {v13, v9, v6}, Lkotlin/text/v;->Q(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v9}, Lapp/jelantara/android/network/APIData;->getPostID()Ljava/lang/String;
    ...
    invoke-static {v9, v13, v6}, Lkotlin/text/v;->Q(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v1, v6}, Lcom/appmysite/baselibrary/custompost/AMSPostListValue;->setItemTitle(Ljava/lang/String;)V

    invoke-virtual {v2}, Lapp/jelantara/android/network/response/GetAllPagesResponseList;->getId()Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v1, v6}, Lcom/appmysite/baselibrary/custompost/AMSPostListValue;->setItemId(Ljava/lang/String;)V
    ...
    invoke-static {v13, v6}, Lkotlin/text/o;->J0(ILjava/lang/String;)Ljava/lang/String;
    ...
    :goto_9
    invoke-virtual {v1, v13}, Lcom/appmysite/baselibrary/custompost/AMSPostListValue;->setItemDesc(Ljava/lang/String;)V
    ...
    :goto_a
    invoke-virtual {v1, v6}, Lcom/appmysite/baselibrary/custompost/AMSPostListValue;->setContent(Ljava/lang/String;)V

    iget-boolean v6, v10, Lkotlin/jvm/internal/B;->c:Z

    invoke-virtual {v1, v6}, Lcom/appmysite/baselibrary/custompost/AMSPostListValue;->setShowExcerpt(Z)V

    invoke-virtual {v2}, Lapp/jelantara/android/network/response/GetAllPagesResponseList;->getCreatedAt()Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v1, v6}, Lcom/appmysite/baselibrary/custompost/AMSPostListValue;->setItemDate(Ljava/lang/String;)V
    ...
    invoke-static {v6}, Lk/d;->c(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_10
    invoke-virtual {v1, v6}, Lcom/appmysite/baselibrary/custompost/AMSPostListValue;->setDateString(Ljava/lang/String;)V
    ...
    invoke-virtual {v6, v13, v9}, Lapp/jelantara/android/network/APIData;->getAPIPageUrl(Ljava/lang/String;Landroid/content/Context;)Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v1, v6}, Lcom/appmysite/baselibrary/custompost/AMSPostListValue;->setItemImageUrl(Ljava/lang/String;)V

    invoke-virtual {v2}, Lapp/jelantara/android/network/response/GetAllPagesResponseList;->isFeatured()Z

    move-result v6

    invoke-virtual {v1, v6}, Lcom/appmysite/baselibrary/custompost/AMSPostListValue;->setFeatured(Z)V
    ...
    :goto_b
    invoke-virtual {v1, v13}, Lcom/appmysite/baselibrary/custompost/AMSPostListValue;->setShowDate(Z)V
    ...
    :goto_c
    invoke-virtual {v1, v6}, Lcom/appmysite/baselibrary/custompost/AMSPostListValue;->setShowAuthor(Z)V
    ...
    invoke-virtual {v6}, Lapp/jelantara/android/network/response/settingsResponse/general1;->getLogin_settings()Lapp/jelantara/android/network/response/settingsResponse/LoginSettings;

    move-result-object v6

    if-eqz v6, :cond_14

    invoke-virtual {v6}, Lapp/jelantara/android/network/response/settingsResponse/LoginSettings;->getDisable_login_signup_module()Ljava/lang/Integer;
    ...
    :goto_10
    invoke-virtual {v1, v6}, Lcom/appmysite/baselibrary/custompost/AMSPostListValue;->setShowBookMark(Z)V

    :cond_19
    :goto_11
    invoke-virtual {v2}, Lapp/jelantara/android/network/response/GetAllPagesResponseList;->isBookmarked()Ljava/lang/Integer;
    ...
    :goto_14
    invoke-virtual {v1, v6}, Lcom/appmysite/baselibrary/custompost/AMSPostListValue;->setBookMarkStatus(Z)V

    invoke-virtual/range {v16 .. v16}, Lapp/jelantara/android/network/APIData$Companion;->getInstance()Lapp/jelantara/android/network/APIData;

    move-result-object v6

    iget-object v13, v3, Lo/h;->d:Landroid/content/Context;

    invoke-virtual {v6, v13}, Lapp/jelantara/android/network/APIData;->getBookmarkList(Landroid/content/Context;)Ljava/util/HashMap;

    move-result-object v6

    invoke-static {v6}, Lkotlin/collections/I;->a0(Ljava/util/Map;)Ljava/util/LinkedHashMap;
    ...
    :cond_1c
    invoke-virtual {v1}, Lcom/appmysite/baselibrary/custompost/AMSPostListValue;->getBookMarkStatus()Z
    ...
    :cond_1d
    iget-object v6, v3, Lo/h;->d:Landroid/content/Context;
    ...
    invoke-interface {v6, v13, v4}, Landroid/content/SharedPreferences;->getBoolean(Ljava/lang/String;Z)Z

    move-result v6

    if-nez v6, :cond_1e

    invoke-virtual {v1, v4}, Lcom/appmysite/baselibrary/custompost/AMSPostListValue;->setBookMarkStatus(Z)V

    :cond_1e
    iget-object v6, v3, Lo/h;->f:Ljava/lang/String;

    invoke-static {v6, v15, v4}, Lkotlin/text/o;->d0(Ljava/lang/CharSequence;Ljava/lang/String;Z)Z
    ...
    :cond_1f
    invoke-virtual {v1}, Lcom/appmysite/baselibrary/custompost/AMSPostListValue;->getShowAuthor()Z
    ...
    :cond_21
    invoke-virtual {v1, v4}, Lcom/appmysite/baselibrary/custompost/AMSPostListValue;->setAuthorName(Ljava/lang/String;)V
    ...
    invoke-virtual {v6}, Lapp/jelantara/android/network/response/AuthorData;->getUserId()Ljava/lang/String;
    ...
    invoke-virtual {v6}, Lapp/jelantara/android/network/response/AuthorData;->getProfileImage()Ljava/lang/String;
    ...
    :goto_18
    invoke-virtual {v4, v9, v6}, Lapp/jelantara/android/network/APIData;->getProfileImageUrl(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v1, v4}, Lcom/appmysite/baselibrary/custompost/AMSPostListValue;->setAuthorImage(Ljava/lang/String;)V

    :cond_25
    invoke-virtual {v12, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v1, v3, Lo/h;->c:Lj/g;

    invoke-interface {v1, v2}, Lapp/jelantara/android/ui/listener/PostPagingListener;->e(Lapp/jelantara/android/network/response/GetAllPagesResponseList;)V
    ...
    new-instance v6, Lapp/jelantara/android/network/models/AttributeValues;

    invoke-direct {v6}, Lapp/jelantara/android/network/models/AttributeValues;-><init>()V
    ...
    invoke-static {v9, v10, v11}, Lkotlin/text/v;->Q(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v1, v9}, Lapp/jelantara/android/network/models/ValueListFilter;->setCategoriesList(Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v1, v9}, Lapp/jelantara/android/network/models/ValueListFilter;->setTagList(Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v6, v9}, Lapp/jelantara/android/network/models/AttributeValues;->setAId(Ljava/lang/String;)V

    invoke-virtual {v5}, Lapp/jelantara/android/network/response/Attributes;->getLabel()Ljava/lang/String;

    move-result-object v9

    invoke-virtual {v6, v9}, Lapp/jelantara/android/network/models/AttributeValues;->setALabel(Ljava/lang/String;)V

    invoke-virtual {v5}, Lapp/jelantara/android/network/response/Attributes;->getIcon_name()Ljava/lang/String;

    move-result-object v9

    invoke-virtual {v6, v9}, Lapp/jelantara/android/network/models/AttributeValues;->setAIconName(Ljava/lang/String;)V

    invoke-virtual {v5}, Lapp/jelantara/android/network/response/Attributes;->getValues()Ljava/util/ArrayList;

    move-result-object v5

    invoke-virtual {v6, v5}, Lapp/jelantara/android/network/models/AttributeValues;->setAttributeList(Ljava/util/ArrayList;)V
    ...
    iget-object v1, v3, Lo/h;->f:Ljava/lang/String;

    const/4 v2, 0x0

    invoke-static {v1, v15, v2}, Lkotlin/text/o;->d0(Ljava/lang/CharSequence;Ljava/lang/String;Z)Z
    ...
    invoke-interface {v2, v1}, Lapp/jelantara/android/ui/listener/PostPagingListener;->a(Ljava/lang/Integer;)V
    ...
    invoke-interface {v2, v0}, Lapp/jelantara/android/ui/listener/PostPagingListener;->a(Ljava/lang/Integer;)V
    ...
    invoke-direct {v1, v0, v9, v7}, Landroidx/paging/PagingSource$LoadResult$Page;-><init>(Ljava/util/List;Ljava/lang/Object;Ljava/lang/Object;)V
